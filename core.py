...
def fetch_pr_diff() -> str:
    """
    Reads the PR diff from a local file generated by the GitHub Actions job.
    The DIFF_FILE environment variable points to the diff file.
    """
    ...
    if os.path.exists(diff_path):
        ...
        with open(diff_path, "r", encoding="utf-8") as f:
            return f.read()
    raise FileNotFoundError("❌ Diff file not found — ensure 'gh pr diff' job created diff.txt")
